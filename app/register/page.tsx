...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      // ========================================================
      // 2. CHỖ NÀY ĐỂ TRỐNG ĐỂ CHÈN CODE API ĐĂNG KÝ SAU NÀY
      // ========================================================
      ...
      // Sau khi đăng ký thành công, thông báo hoặc chuyển về trang đăng nhập
      ...
      <nav className='bg-white/90 backdrop-blur-md border-b border-[#CFECF3] px-8 py-4 shadow-sm w-full'>
        <div className='max-w-6xl mx-auto flex justify-between items-center'>
          <div className='flex items-center gap-2 cursor-pointer' onClick={() => router.push('/')}>
            <span className='text-2xl font-black bg-gradient-to-r from-[#FBBFDC] to-[#99DDF0] bg-clip-text text-transparent tracking-wider font-mono'>JoyRide</span>
          </div>
          <button 
      ...
      <main className='flex-1 flex items-center justify-center px-6 py-12 relative z-10'>
        ...
        <div className='w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 border border-[#CFECF3]/40 shadow-xl shadow-stone-200/30 relative overflow-hidden'>
          ...
          <div className='text-center space-y-2 mb-8'>
            <h1 className='text-2xl sm:text-3xl font-black text-stone-900 tracking-tight'>Tạo tài khoản mới</h1>
          ...
          {error && (
            <div className='mb-5 p-3.5 bg-rose-50 border border-rose-200/60 text-rose-700 text-xs font-semibold rounded-xl leading-relaxed animate-fade-in'>
              ⚠️ {error}
            </div>
          )}
          ...
          <form onSubmit={handleRegister} className='space-y-4'>
            ...
            <div className='space-y-1.5'>
              <label className='text-xs font-bold text-stone-500 uppercase tracking-wider pl-1'>Họ và Tên</label>
              <input 
            ...
            {/* Email */}
            <div className='space-y-1.5'>
              <label className='text-xs font-bold text-stone-500 uppercase tracking-wider pl-1'>Địa chỉ Email</label>
              <input 
            ...
            {/* Mật khẩu */}
            <div className='space-y-1.5'>
              <label className='text-xs font-bold text-stone-500 uppercase tracking-wider pl-1'>Mật khẩu</label>
              <input 
            ...
            {/* Xác nhận mật khẩu */}
            <div className='space-y-1.5'>
              <label className='text-xs font-bold text-stone-500 uppercase tracking-wider pl-1'>Xác nhận mật khẩu</label>
              <input 
